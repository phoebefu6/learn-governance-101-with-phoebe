...
(function () {
  ...
  /* Journey strip: you-are-here (single on-ramp track of 6) */
  ...
  if (crumb && mastheadWrap) {
    ...
    if (m) {
      ...
      var pages = ["a1-what-is-data.html", "a2-vocabulary.html", "a3-regime-map.html",
           "a4-breach.html", "a5-dpo-roles.html", "a6-next-steps.html"];
      var journey = document.createElement("div");
      journey.className = "journey";
      var jl = document.createElement("span");
      jl.className = "jlabel";
      jl.textContent = "Your on-ramp";
